...
tags: ['react', 'vite']
---
Configuring the <a href="https://vite.dev" target="_blank">Vite</a> reverse proxy allows us to redirect requests that match a pattern and direct them to a specific server. This is especially useful during the development stage, since it allows our frontend application to communicate with a specific API, such as a mock server using <a href="https://www.npmjs.com/package/json-server" target="_blank">JSON-Server</a> or a local instance of the backend project.
